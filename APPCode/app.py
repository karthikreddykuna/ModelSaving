...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/ModelSaving/master/APPCode/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -50155.024516367
...
# User defined values
title = 'App'
encoder_location = 'https://github.com/karthikreddykuna/ModelSaving/blob/master/APPCode/encoder.pkl?raw=true'
