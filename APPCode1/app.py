...
tpot_data = pd.read_csv('ModelSaving/APPCode/https://raw.githubusercontent.com/karthikreddykuna/ModelSaving/master/APPCode1/prepared_data.csv')
...
# User defined values
title = 'App'
encoder_location = 'https://github.com/karthikreddykuna/ModelSaving/blob/master/APPCode1/encoder.pkl?raw=true'
